...
```bash
python3 validator/scripts/health/check_validator_health.py
```

```bash
python3 validator/scripts/health/check_validator_health.py --single-check --network finney
```

```bash
python3 validator/scripts/health/check_validator_health.py --last-epochs 10
```

```bash
python3 validator/scripts/health/check_current_epoch_weights.py \
  --netuid 124 \

...
WORLD_RANGE = 5        # random scenery is placed in ±WORLD_RANGE (m)
HEIGHT_SCALE = 1.8  # scale factor for the height of obstacles, lower tends to create easier maps
N_OBSTACLES = 0  # number of random obstacles in the world
...
CAM_HZ:  int    = 60
# ───────────────────────────────────────────
R_MIN, R_MAX = 10, 20          # radial goal distance (m)
H_MIN, H_MAX = 10, 20          # radial goal distance (m)
# ───────────────────────────────────────────
